(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function c(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const l="/assets/ncp-logo-f1944a85.png",u="/assets/link-707baf7d.svg",f="/assets/github-d0312bf6.svg",y="/assets/x-9bb1ed28.svg",k="/assets/discord-bd04cdd8.svg",_="/assets/youtube-733a09bd.svg",w="/assets/gmail-aa9bddda.svg";console.log(l,u);function d(){document.documentElement.style.setProperty("--vh",`${window.innerHeight/100}px`),addEventListener("load",d),addEventListener("resize",d),addEventListener("orientationchange",d)}function E(){const t=new IntersectionObserver(a=>{a.forEach(c=>{c.isIntersecting&&(c.target.classList.add("show"),c.target.classList.contains("page-header")&&c.target.setAttribute("animate",""))})});document.querySelectorAll(".hidden").forEach(a=>t.observe(a))}function i(t,s,a,c){s=="tab"?a=="link"?c.key=="Enter"&&window.open(t,"_blank"):a=="page"&&c.key=="Enter"&&(window.location.href=t):a=="link"?window.open(t,"_blank"):window.location.href=t}const L="../../",S="../../blogs/",q="../../blogs/all-about-me/",x="../../blogs/the-computer-science-speedrun/",g="../../privacy-policy/",P="https://github.com/KingPr0o7/Combo-Menu",m="https://discord.gg/QGDPS6wHB8",b="https://www.youtube.com/channel/UCmMcPTUznYtu3zo7X3sVbgA",p="https://x.com/KingPr0o7",h="https://mail.google.com/mail/?view=cm&fs=1&to=nathan@ncp.dev&su=&body=",v="https://github.com/KingPr0o7",C="https://github.com/KingPr0o7/KingPr0o7.github.io#404-filepage-not-found-online-only",M="https://www.githubstatus.com/",K="https://twitter.com/githubstatus?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor",$="https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement",G="https://docs.github.com/en/pages/getting-started-with-github-pages/about-github-pages#data-collection",O="https://github.com/KingPr0o7/KingPr0o7.github.io",A="https://code.org/",H="https://palletsprojects.com/p/flask/",N="https://github.com/KingPr0o7/Combo-Menu/commits/main";var e=document.createElement("div");e.innerHTML=`
    ...
    <div id='footer-modal-container'>
        <div id="footer-modal-content">
            ...
            <div id="gmail-link" tabindex="0">
                <img id="link-image" src="${u}" alt="Redirect Icon" />
    ...
    <div class="hidden" id="footer">
        <div id="footer-container">
            <div id="footer-content">
                <div id="footer-logo">
                    <img id="footer-icon" src="${l}" alt="NCP Icon" title="NCP Logo">
                </div>			
...
`;e.querySelector("#contact-github").addEventListener("click",t=>i(v,"click","link",t));e.querySelector("#contact-github").addEventListener("keydown",t=>i(v,"tab","link",t));e.querySelector("#contact-x").addEventListener("click",t=>i(p,"click","link",t));e.querySelector("#contact-x").addEventListener("keydown",t=>i(p,"tab","link",t));e.querySelector("#contact-discord").addEventListener("click",t=>i(m,"click","link",t));e.querySelector("#contact-discord").addEventListener("keydown",t=>i(m,"tab","link",t));e.querySelector("#contact-youtube").addEventListener("click",t=>i(b,"click","link",t));e.querySelector("#contact-youtube").addEventListener("keydown",t=>i(b,"tab","link",t));e.querySelector("#contact-gmail").addEventListener("click",()=>e.querySelector("[data-modal]").showModal());e.querySelector("#contact-gmail").addEventListener("keydown",t=>t.key=="Enter"?e.querySelector("[data-modal]").showModal():null);e.querySelector("#gmail-link").addEventListener("click",t=>i(h,"click","link",t));e.querySelector("#gmail-link").addEventListener("keydown",t=>i(h,"tab","link",t));e.querySelector("[data-close-modal]").addEventListener("click",()=>e.querySelector("[data-modal]").close());e.querySelector("[data-close-modal]").addEventListener("keydown",t=>t.key=="Enter"?e.querySelector("[data-modal]").close():null);e.querySelector("#footer-privacy").addEventListener("click",t=>i(g,"click","page",t));e.querySelector("#footer-privacy").addEventListener("keydown",t=>i(g,"tab","page",t));function I(){d(),document.body.appendChild(e),E()}export{q as a,x as b,S as c,P as d,$ as e,G as f,M as g,L as h,O as i,A as j,H as k,N as l,C as r,I as s,i as t,K as x};
